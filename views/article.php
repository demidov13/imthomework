...
<div class="row mt-5">
    <div class="col">
        <form name="article" method="post" <?php if($_GET['action'] == 'edit'): ?> action="index.php?action=edit" <?php endif?> <?php if($_GET['action'] == 'article'): ?> action="index.php?action=article" <?php endif?>>
